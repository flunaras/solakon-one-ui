...
#   opensuse-tumbleweed-aarch64  openSUSE Tumbleweed, aarch64, Qt6 (cross-compiled)
...
case "$DISTRO" in
    ...
    *)
        echo "ERROR: --distro must be one of: opensuse-tumbleweed-x86_64, opensuse-tumbleweed-aarch64, ubuntu-24.04-x86_64, all" >&2
        exit 1 ;;
esac
...
build_for_distro() {
    ...
    docker run --rm \
        ...
        bash -c "
            ...
            cmake_args=(/src -B /build -G Ninja \
